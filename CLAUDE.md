...
- **Brand is a hard constraint:** one coral accent (`#FF5A4D`), serif headlines + sans body, generous whitespace, and honored `prefers-reduced-motion`. Don't add a second accent or flatten motion.
